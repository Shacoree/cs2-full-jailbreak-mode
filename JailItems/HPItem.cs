...
{
    public class HPItem : JailItem
    {
        public static new readonly int costT = JailBreak.jailbreak.Config.ItemCost.costHPT;
        public static new readonly int costCT = JailBreak.jailbreak.Config.ItemCost.costHPCT;

        public HPItem(CCSPlayerController player, string name)
        {
            this.name = name;
            this.player = player;
            GiveItemToPlayer();
        ...
        public override void GiveItemToPlayer()
        {
            ...
            player.PlayerPawn.Value.Health = JailBreak.jailbreak.Config.ItemCost.valueHPCT;
